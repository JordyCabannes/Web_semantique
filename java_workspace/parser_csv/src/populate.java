...
/*cette classe contient le code qui permet de peupler les ontologies
 Il faut changer les chemins des fichiers csv si vous voulez exécuter le code sur votre  machine */
	...
	public static void main(String args[])
	{
		...
		try {
			...
			while(it.hasNext())
			{
				 ...
				 * 
				 */
				OWLDatatype Stringtype;
				OWLLiteral literal13;
				OWLDataProperty pro_URL;
				OWLDataPropertyAssertionAxiom KYGO ;
				...
				if (retour.get("Poster")!=null &&   retour.get("Poster").equals("N/A")==false)
				{
					 ...
					 literal13 = factory.getOWLLiteral(retour.get("Poster"),Stringtype); //creation DATE DE SORTIE

					 pro_URL=factory.getOWLDataProperty(":url_affiche",pmonto);// récupération de la dataproperty définie dans onto
				 ...
				 * 
				 */
				 if(retour.get("imdbRating")!=null && retour.get("imdbRating").equals("N/A")==false)
				{
				 ...
				 * 
				 */
				 if(retour.get("Plot")!=null && retour.get("Plot").equals("N/A")==false)
				{
					 Stringtype = factory.getOWLDatatype(OWL2Datatype.XSD_STRING.getIRI());//recuration du type INTEGER
				 ...
				 */
				 ...
				 if(retour.get("Actors")!=null && retour.get("Actors").equals("N/A")==false)
				{
				 ...
				 * 
				 */
				 if(retour.get("Country")!=null && retour.get("Country").equals("N/A")==false)
				{
		...
		while(itbis.hasNext() && cpt <300)
		{
		 ...
		 //exemple de récupération d'une classe dans l'ontologie onto
			...
			//System.out.println("b" +ie);// dans la vraie vie , on ne catch pas les exceptions de cette manière 
			ie.printStackTrace();//the right way 
